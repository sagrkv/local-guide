  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-400 mt-1">Overview of your lead pipeline</p>
      </div>
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <p className="text-sm text-gray-400 mt-1">Review incoming leads</p>
            </Link>
            <Link
              href="/admin/scraping"
              className="p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors"
            ...
            >
              ...
              <p className="text-sm text-gray-400 mt-1">Manage pipeline</p>
            </Link>
            <Link
              href="/admin/settings"
              className="p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors"
            >
              ...
              <p className="text-sm text-gray-400 mt-1">Configure regions</p>
            </Link>
          </div>
    ...
    <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className={`text-3xl font-bold mt-1 ${color ? colorClasses[color] : 'text-white'}`}>
