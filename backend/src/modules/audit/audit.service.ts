...
export const AuditActions = {
  ...
  POI_APPROVED: 'POI_APPROVED',
  POI_PUBLISHED: 'POI_PUBLISHED',
  ...
  // Discovery
  DISCOVERY_JOB_STARTED: 'DISCOVERY_JOB_STARTED',
  DISCOVERY_JOB_COMPLETED: 'DISCOVERY_JOB_COMPLETED',
  DISCOVERY_JOB_FAILED: 'DISCOVERY_JOB_FAILED',
  DISCOVERY_JOB_CANCELLED: 'DISCOVERY_JOB_CANCELLED',
